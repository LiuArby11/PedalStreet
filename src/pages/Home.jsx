...
export default function Home({ isAdmin, session }) { // Inalis natin ang addToCart dito dahil via Details na ang flow
  ...
  const userName = session?.user?.user_metadata?.display_name || session?.user?.email?.split('@')[0] || 'Rider';
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10 text-center">
          <div className="inline-flex items-center gap-2 bg-white/5 border border-white/10 px-4 py-1.5 rounded-full mb-8">
            ...
            <p className="text-[9px] font-black uppercase tracking-[0.3em] text-gray-400">
              {isAdmin ? 'System Overlord Online' : 'Global Distribution Active'}
            </p>
          </div>
          ...
          <h1 className="text-7xl md:text-9xl font-black italic uppercase tracking-tighter text-white leading-[0.85] mb-8">
            ...
            <span className="text-3xl md:text-5xl text-gray-600 font-bold tracking-[-0.05em]">UNLEASH THE BEAST</span>
          </h1>
          ...
          <p className="max-w-xl mx-auto text-gray-500 font-medium text-sm md:text-base mb-10 tracking-tight">
            ...
            Your premium tactical cycling gear is ready for deployment.
          </p>
      ...
      <div id="inventory" className="max-w-7xl mx-auto px-6 py-20">
        ...
        {loading ? (
          <div className="flex flex-col items-center justify-center py-40">
            ...
            <p className="font-black uppercase tracking-[0.5em] text-gray-700 text-xs">Syncing Logistics...</p>
          </div>
